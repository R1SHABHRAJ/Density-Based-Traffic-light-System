...
void loop(){
  ...
  delay(6000);//Green lights on for 6s
...
//MODE2 = vehicle in lane 1 and 2(left and right) and they are 
  ...
  //sufficient time for vehicle to pass
  delay(12000);//Green lights on for 12s
  digitalWrite(ledPinY1, HIGH);
  delay(4000);
  digitalWrite(ledPinY1, LOW);
  lowled();
...
//MODE1 = vehicle in lane 3 and 4(left and right) and they are 
...
else if(dist1<=25 & dist1>=15 & dist2<=25 & dist2>=15 & dist3<=15 & dist4<=15){
   //more obstacle in lane 3 and 4 + less traffic on lane 1 and 2
  digitalWrite(ledPinR1, HIGH);
  digitalWrite(ledPinR2, LOW);
  digitalWrite(ledPinG1, LOW);
  digitalWrite(ledPinG2, HIGH);
  Serial.println("MODE 5 ACTIVE");
  //more time for vehicle to pass away
  delay(8000); //Green lights on for 8s in lane 3 and 4
  digitalWrite(ledPinY1, HIGH);
  digitalWrite(ledPinY2, HIGH);
  delay(3000);
  digitalWrite(ledPinY1, LOW);
...
else if(dist3<=25 & dist3>=15 & dist4<=25 & dist4>=15 & dist1<=15 & dist2<=15){
   //heavy traffic in lane 1 and 2 + less traffic on lane 3 and 4
  digitalWrite(ledPinR1, LOW);
  digitalWrite(ledPinR2, HIGH);
  digitalWrite(ledPinG1, HIGH);
  digitalWrite(ledPinG2, LOW);
  Serial.println("MODE 6 ACTIVE");
  //more time for vehicle to pass away
  delay(8000); //Green lights on for 8s in lane 3 and 4
  digitalWrite(ledPinY1, HIGH);
  digitalWrite(ledPinY2, HIGH);
...
else if(dist1<=25 & dist1>=15 & dist2<=25 & dist2>=15 & dist3<=25 & dist3>=15 & dist4<=25 & dist4>=15){
   //light traffic in all lanes
  digitalWrite(ledPinR1, HIGH);
  digitalWrite(ledPinR2, LOW);
  digitalWrite(ledPinG1, LOW);
  digitalWrite(ledPinG2, HIGH);
  Serial.println("MODE 7 ACTIVE");
  //more time for vehicle to pass away
  delay(4000); //Green lights on for 8s in lane 3 and 4
  digitalWrite(ledPinY1, HIGH);
  digitalWrite(ledPinY2, HIGH);
  delay(2500);
  digitalWrite(ledPinY1, LOW);
  ...
  lowled();
   ...
   //heavy traffic in all lanes
  digitalWrite(ledPinR1, HIGH);
  digitalWrite(ledPinR2, LOW);
  digitalWrite(ledPinG1, LOW);
  digitalWrite(ledPinG2, HIGH);
  Serial.println("MODE 8 ACTIVE");
  //more time for vehicle to pass away
  delay(8000); //Green lights on for 8s in lane 3 and 4
  digitalWrite(ledPinY1, HIGH);
  digitalWrite(ledPinY2, HIGH);
  ...
  digitalWrite(ledPinG1, LOW);
  digitalWrite(ledPinG2, LOW);
  Serial.println("MODE 9 ACTIVE");
  delay(1000);
  // More such mode can be created based on the user 
}
}
